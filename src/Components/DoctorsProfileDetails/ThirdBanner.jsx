        ...
        <div className='bg-[#EFEFEF] px-10 lg:px-40 pb-20'>
            <section className='flex rounded-2xl flex-col p-8 bg-white'>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    {
                        professionalData.available ? (<div className='px-3.5 py-1.5 rounded-full bg-[#09982f16] text-[#09982fd9] pjsm text-[12px] sm:text-sm text-center border-1 border-[#09982f2b]'>
                            ...
                            flag ? (
                                ...
                                User ? (
                                    <Link onClick={() => {
                                        ...
                                        window.scrollTo(0, 0)
                                        toast.success(`Appointment scheduled for ${professionalData.name} successfully`)
