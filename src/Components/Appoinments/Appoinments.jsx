                    ...
                    <div>
                        <div className='bg-[#EFEFEF] sm:px-40 sm:py-8'>
                            <section className='flex flex-col justify-center items-center px-40 py-[72px] bg-white rounded-3xl'>
                                <h1 className='pjseb text-2xl/snug sm:text-5xl/snug text-center mb-4'>No Appointments Today</h1>
                                <p className='pjsm text-[12px] sm:text-lg text-center text-[#0f0f0f9c] mb-8'>Looks like your schedule is clear for today! No appointments to worry about.</p>
